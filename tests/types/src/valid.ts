...
stripe
  ...
  .then(async (checkout) => {
    ...
    const checkoutLinkSignupElement: StripeLinkSignupElement = checkout.createLinkSignupElement();
    ...
    const retrievedCheckoutLinkSignupElement: StripeLinkSignupElement | null = checkout.getLinkSignupElement();
