...
export interface Stripe {
  ...
  /**
   * Use `stripe.confirmAmazonPaySetup` in the [Amazon Pay](https://docs.stripe.com/payments/amazon-pay) flow when the customer submits your payment form.
   * When called, it will confirm the [SetupIntent](https://stripe.com/docs/api/setup_intents) with `data` you provide.
   * Refer to our [integration guide](https://docs.stripe.com/payments/amazon-pay/accept-a-payment) for more details.
   *
   * @docs https://docs.stripe.com/js/setup_intents/confirm_amazon_pay_setup
   */
